...
struct RunningWorkout
{
    ...
    {
        var holder = distance / 1600
        return time / holder
    }
}

var newRunningWorkout = RunningWorkout(distance: 3200, time: 10, elevation: 50)

newRunningWorkout.averageMileTime
/*:
...
var newStepsInstance = Steps(steps: 9998, goal: 10000)
newStepsInstance.takeStep()
