...
var newBook = Book(title: "Mistborn", author: "Brandon Sanderson", pages: 360, price: 14.56)
...
struct Height
{
    ...
    init(heightInches heightInInches: Double)
    {
    ...
    init(heightCentimeters heightInCentimeters: Double)
    {
 ...
 */
var someonesHeight = Height.init(heightInches: 65)
